<template>
  <div class="wrap">
              ...
              <el-popover
                ...
                <el-scrollbar
                  ...
                  <div style="max-height: 120px">
                    <ul v-for="item in filterUserList">
                      <li @click="choice(item)">{{item}}</li>
                    </ul>
                  </div>
                </el-scrollbar>
              </el-popover>
    ...
    <footer class="common_flex" style="position:relative">
      <div class="hvr-float-shadow" style="z-index: 1;">版权所有&nbsp;:&nbsp;北京中安星云软件技术有限公司</div>
    </footer>
  ...
  export default {
    ...
    data() {
      return {
        ...
        verifyCodeInfo: {},
        show:false,
        list:['SysAdmin','SecAdmin','Auditor']
      }
    },
    computed: {
      loginButtonStatus() {
      ...
      filterUserList(){
        let arr = new Set()
        this.list.map(item => item.toUpperCase().search(this.form.username.toUpperCase()) != -1 ? arr.add(item) : '')
